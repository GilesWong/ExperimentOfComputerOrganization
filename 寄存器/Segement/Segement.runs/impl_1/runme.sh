...
HD_PWD='C:/Users/wangwenge/Documents/Segment1/Segement/Segement.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Segment_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Segment_top.tcl -notrace
