...
HD_PWD='C:/Users/wangwenge/Documents/Segment1/Segement/Segement.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Segment_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Segment_top.tcl
