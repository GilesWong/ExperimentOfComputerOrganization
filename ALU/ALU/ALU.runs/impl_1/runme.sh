...
HD_PWD='C:/Users/wangwenge/Documents/ALU/ALU/ALU.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log ALU_M.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source ALU_M.tcl -notrace
