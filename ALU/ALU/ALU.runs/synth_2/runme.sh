...
HD_PWD='C:/Users/wangwenge/Documents/ALU/ALU/ALU.runs/synth_2'
cd "$HD_PWD"
...
EAStep vivado -log ALU_M.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ALU_M.tcl
