...
HD_PWD='C:/Users/wangwenge/Documents/MemoryIP/R_I_J_CPU/R_I_J_CPU.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log R_TOP.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source R_TOP.tcl
