...
HD_PWD='C:/Users/wangwenge/Documents/MemoryIP/MemoryIP/MemoryIP.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log RAM_B_Test.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source RAM_B_Test.tcl
