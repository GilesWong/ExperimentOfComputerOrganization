...
HD_PWD='C:/Users/wangwenge/Documents/R_I_J_CPU/R_I_J_CPU.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log R_I_J_TOP.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source R_I_J_TOP.tcl -notrace
