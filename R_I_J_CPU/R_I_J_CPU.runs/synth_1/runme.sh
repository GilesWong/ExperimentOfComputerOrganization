...
HD_PWD='C:/Users/wangwenge/Documents/R_I_J_CPU/R_I_J_CPU.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log R_I_J_TOP.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source R_I_J_TOP.tcl
