...
HD_PWD='C:/Users/wangwenge/Documents/Fetch_Instr/Fetch_Instr.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Fetch_Instr_Top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Fetch_Instr_Top.tcl -notrace
