...
HD_PWD='C:/Users/wangwenge/Documents/Fetch_Instr/Fetch_Instr.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Fetch_Instr_Top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Fetch_Instr_Top.tcl
